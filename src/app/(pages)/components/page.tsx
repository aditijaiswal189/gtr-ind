...
import { Briefcase, Contact, FileCheck, Globe, Notebook, Plane, UserCheck } from 'lucide-react';
...
const Page: React.FC = () => {
    return (
      ...
      <h1 className='text-center text-3xl'>CtaWith4Features</h1>
            ...
            <CtaWith4Features  features={aboutFeatures}
...
<FAQ2/>
  ...
  <FeaturesWithLastFilled  services={services}
