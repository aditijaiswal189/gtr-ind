...
import { CheckCircle, MapPin, FileCheck, LifeBuoy, Star, Smile, Award, Heart, Notebook, Briefcase } from 'lucide-react'
...
export const items2: Cta4FeatureItemProps[] = [
  ...
  },
  {
   ...
   const items: FeatureItemPropsList[] = [
    { icon: Star, text: 'Settle in Québec to work here.You must practise your profession or business activities in Québec, alone or with others, with or without paid help.' },
    { icon: Smile, text: 'You must have a net worth of at least CDN$100,000. You can share this net worth with your spouse or common-law partner who is accompanying you to Québec. You must be able to demonstrate the legal origin and accumulation of your net worth.' },
    { icon: Award, text: 'You will need to make a start-up deposit with a financial institution located in the area where you plan to practise your trade or profession:1.Outside the Communauté métropolitaine de Montréal (CMM), the start-up deposit is CDN$25,000.2. On the territory of the CMM, the start-up deposit is CDN$50,000.You will need to make the deposit after you receive the letter that confirms the opening of your file' },
 
    { icon: Heart, text: 'You are awarded points for each factor as education, age language .. and criterion on the grid. You must obtain 63 out of 107 points on the grid to meet the cut-off for factors and criteria that have an elimination threshold.' },
    {icon:Notebook, text: "You must obtain your attestation within a maximum of 60 days after receiving this request"},
    {icon:Briefcase, text: "If you wish to practise a regulated profession or trade in Québec, you must obtain the legal right to practise, even if you have obtained a degree or license outside of Québec"}
  ]

const QuSelfEmployed: React.FC = () => {
    return (
         <div className="min-h-screen bg-white flex gap-12 flex-col">
                       <Hero2 badgeText='GreenTech Resources' title='Québec Self-Employed Program' description='Settle in Québec and work for yourself - for those with experience in arts, cultural or athletic activities' imageUrl='/images/hero/i.avif' primaryCta={{ label: "Quebec Enterpreneur Program", href: "/" }} secondaryCta={{ label: "Learn More", href: "/" }}/>
