...
import React from 'react';
 ...
 const items: FeatureItemPropsList[] = [
    { icon: Star, text: ' Want to start and operate an innovative business in Québec' },
    { icon: Smile, text: 'Have received a service offer from an organization that is committed to supporting you' },
    { icon: Award, text: 'Have qualified business plan' },
 
    { icon: Heart, text: 'Obtain enough points in the program’s selection grid' },
    {icon:Notebook, text: "Obtain an attestation of learning about democratic values "}
  ]
   const features2 = [
    { 
    ...
    },
    {
      ...
      description: "An organization with an establishment in Québec that offers coaching services to people whose business projects are designed to start innovative businesses",
    },
    {
      icon: "Layers" as const,
      title: "University Entrepreneurship Center",
      description: "An organization managed by an institution of higher learning incorporated under the laws of Québec or another province of Canada. It may also be an organization affiliated with such an institution that offers coaching services to entrepreneurs",
    },
  ];
 ...
 const QuEnterpreneurProgram: React.FC = () => {
    return (
         <div className="min-h-screen bg-white flex gap-12 flex-col">
               ...
               <Hero2 badgeText='GreenTech Resources' title='Québec Entrepreneur Program' description='The Québec Entrepreneur Program is tailored for individuals interested in owning and managing a business in Quebec' imageUrl='/images/hero/h.avif' primaryCta={{ label: "Quebec Immigrant Investor Program", href: "/" }} secondaryCta={{ label: "Learn More", href: "/" }}/>
