...
import { Award, Briefcase, Coffee, Globe, Heart, Notebook, Smile, Star, UserCheck, Zap } from 'lucide-react';
import React, { ReactNode } from 'react';

 const items: FeatureItemPropsList[] = [
    { icon: Star, text: 'Two years of suitable management or business experience within the five years preceding the application' },
    { icon: Smile, text: 'Investment of $1.2 million into a passive government-guaranteed investment for a period of five years bearing no interest' },
    { icon: Award, text: 'Intend to settle in the province of Quebec' },
    { icon: Zap, text: 'Enter into an investment agreement with a financial intermediary, either an investment broker or a trust company that has signed an agreement with the Ministère de l Immigration, de la Francisation et de l Intégration and IQ Immigrants investisseurs Inc' },
    { icon: Heart, text: 'Make a 5 year term investment: You must make a five-year term investment of CDN$1,200,000. The investment must be made with IQ Immigrants Investisseurs inc. The investment is guaranteed by the Gouvernement du Québec.' },
    { icon: Coffee, text: 'Obtain enough points in the selection grid' },
    {icon:Notebook, text: "Obtain an attestation of learning about democratic values and Québec values"}
  ]
 ...
 const QuInvestor: React.FC = () => {
    return (
        <div className="min-h-screen bg-white flex gap-12 flex-col">
                <Hero2 badgeText='GreenTech Resources' title='Québec Immigrant Investor Program (QIIP)' description='This program is designed for high-net-worth individuals who wish to invest in the Quebec economy Applicants must have these qualifications' imageUrl='/images/hero/g.avif' primaryCta={{ label: "Quebec Enterpreneur Program", href: "/" }} secondaryCta={{ label: "Learn More", href: "/" }}/>
