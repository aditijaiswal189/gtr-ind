import { Cta4FeatureItemProps, Cta4FeaturesWithoutImage } from '@/components/ui/cta4-features-without-image';
import { FeatureItemListProps, FeatureListWithImage } from '@/components/ui/feature-list-with-image';
import { FeatureItemPropsList, FeatureList } from '@/components/ui/features-list';
...
import { Award, CheckSquare, ClipboardCheck, Compass, FileCheck,  Globe2,  Lightbulb, MapPin, Notebook, Smile, Star, Users, Zap } from 'lucide-react';
...
export const featuresConfig: FeatureItemListProps[] = [
  { text: 'Freedom to live, study, and work across the entire Canadian territory', Icon: Star },
{ text: 'With PR, university tuition fees are only 1/3rd of what international students pay', Icon: CheckSquare },
  { text: 'No restrictions on schools and programs', Icon: Globe2 },
  
  
    { text: 'Eligibility to apply for Canadian citizenship after the waiting period.', Icon: CheckSquare },
  { text: 'Access to social welfare', Icon: Zap },
  { text: ' Qualify to apply for Canadian citizenship( 6th strongest passport globally), enjoy direct ETA access to 185 countries', Icon: Globe2 },

]
 const items: FeatureItemPropsList[] = [
    { icon: Star, text: ' When granted permanent residence: Actively manage business in Canada, essential operations and incorporated in Canada.' },
    { icon: Smile, text: 'Qualifying-BusinessWhen committing: Each applicant owns 10%+ voting rights.' },
    { icon: Award, text: 'Letter of Support - Obtain a support letter from designated organization: Start-up Incubators, Angel Investor Group or Venture Capital Funds' },
 
   
    {icon:Notebook, text: "Language Proficiency- Meet the minimum CLB 5 in either English or French in all 4 skills (listening,reading,writing and speaking)"}
  ]
    const stepsBenefit = [
    {
 ...
 const  StartUpVisa: React.FC = () => {
    return (
         <div className="min-h-screen bg-white flex gap-12 flex-col">
                       <Hero2   badgeText='GreenTech Resources' title='Start Up Visa (SUV)' description='Start Up Visa Program - Canada Immigration Program that allows talented entrepreneurs and their family from abroad to come, establish and manage new businesses in Canada with Work / Visitor/ Study Permit while waiting for Permanent residency
' imageUrl='/images/hero/n.avif' primaryCta={{ label: "Intra Company Transfer", href: "/" }} secondaryCta={{ label: "Learn More", href: "/" }}/>
                   <FeatureList
