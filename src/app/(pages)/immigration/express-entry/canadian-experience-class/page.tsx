              ...
              features={[
                {
                  icon: "Briefcase",
                  title: " WORK EXPERIENCE",
                  description: "Work experience in Canada in occupations classified under NOC skill levels 0, A, or B with a minimum of 1 year of experience in the last 3 years",
                //   link: "/global"
                },
              
                {
                  icon: "Notebook",
                  title: "Education",
                  description: "Have a credential issued in Canada or possess a recognized equivalent to a Canadian credential",
                },
                ...
                },
                {
                    icon: "Notebook",
                    title: "Language",
                    description: "Meet the minimum language proficiency requirements in either English or French-For NOC skill level 0 or A occupations: Minimum CLB/NCLC 7.For NOC skill level B occupations: Minimum CLB/NCLC 5",
                  },
              ]}
            />
