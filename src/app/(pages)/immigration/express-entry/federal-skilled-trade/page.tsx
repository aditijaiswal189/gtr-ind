...
const features: FeatureItemData[] = [
    ...
    },
    {
      ...
      title: 'Carpenters',
      description: ' Carpenters construct, renovate, and repair wooden structures and frameworks',
      icon: <Cloud />,
    },
    {
    ...
    },
    {
      ...
      description: 'Automotive service technicians diagnose and repair problems in vehicles',
      icon: <Heart />,
    },
    {
      ...
      description: 'Crane operators operate cranes to lift and move heavy materials',
      icon: <Heart />,
    },
    {
      ...
      description: 'prepare and cook a wide variety of foods; package meat products; create and bake a diverse range of bread, pastries, and desserts',
      icon: <Heart />,
    },
  ]
  const features2 = [
              ...
              features={[
                {
                  ...
                  description: " Have at least 2 years of full-time work experience (or an equal amount of part-time work experience) in a skilled trade within the 5 years before you apply.Meet the job requirements for that skilled trade as set out in the National Occupational Classification (NOC)",
                //   link: "/global"
                },
                {
                    icon: "Notebook",
                    title: "Language",
                    description: " At least CLB/NCLC 4 for Reading and Writing, and CLB/NCLC 5 for Listening and Speaking in order to be eligible for Federal Skilled Trades Program",
                  },
                {
                  icon: "Rocket",
              ...
              
                {
                  icon: "Users",
                  title: "  CRS",
                  description: "Pass the initial screening with a score of 67 points. Before applying, candidates should carefully review the program requirements and ensure they meet the necessary qualifications. Additionally, individuals in skilled trades may also consider seeking employment through the Provincial Nominee Program (PNP) if a particular province has a demand for their skills.",
                },
              ]}
            />
             <Feature2WithImage
