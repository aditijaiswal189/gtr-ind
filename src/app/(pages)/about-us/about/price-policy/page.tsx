...
import PricingSection, { PricingSectionConfig } from '@/components/ui/pricing-section';
...
const aboutPricingConfig: PricingSectionConfig[] = [{
   ...
   //   { title: "Student", description: "Best for students", price: "Free" },
     { title: "Fresh Applicant", description: "Additional $250 for each member", price: 500, isPopular: true },
     { title: "Post-refusal Applicant", description: "Additional $250 for each member", price: 750 },
     { title: "Visitor Visa (Extension)", description: "Additional $250 for each member", price: 500 },
     { title: "Visitor Visa - Inside Canada", description: "Additional $250 for each member", price: 500 },
     { title: "Dependent of Int. Student", description: "Additional $250 for each member", price: 500 },
     { title: "Restoration of Visitor Visa", description: "Additional $300 for each member", price: 750 },
   ],
 },{
  heading:"Worker",
  description: "Plans",
   ...
   plans: [
     ...
     { title: "No LMIA required", description: "", price: 2500, isPopular: true },
 ...
 ,{
  ...
  description: "Plans",
   ...
   plans: [
     ...
     { title: "Fresh Applicant", description: "", price: 1000, isPopular: true },
 ...
 ,{
  ...
  description: "Plans",
   ...
   plans: [
     ...
     { title: "Express Entry Profile Creation", description: "", price: 500, isPopular: true },
     { title: "FSW / FSTW / CEC / PNP - Post ITA", description: "Additional CAD 500 for family members", price: 3000 },
     { title: "PNP submission till PR", description: "Additional CAD 500 for family members", price: 5000 },
 ...
 ,{
  ...
  description: "Plans",
   ...
   plans: [
     ...
     { title: "Spouse / Partner Outside Canada", description: "", price: 3500, isPopular: true },
