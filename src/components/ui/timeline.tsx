...
const items: TimelineData[] = [
  {
    ...
    content: 'We have an expert team of immigration and business coordinators who are the backbone of making 1000s of successful visas.',
    icon: 'Plane',
  ...
  },
  {
    id: 'success-stories',
    title: 'Work and Jobs',
    content: 'We have an expert team of business coordinators who are the backbone of making 1000s of successful visas.',
    icon: 'FileText',
  ...
  },
  {
    ...
    content: 'We have an expert team of education coordinators who are the backbone of making 1000s of successful visas.',
    icon: 'Notebook',
  ...
  },
  {
    ...
    title: 'Business',
    content: 'Immigration and Citizenship Consultants registered immigration consultancy that abides by Canadian immigration laws.',
    icon: 'Briefcase',
    imageUrl:"/images/fea/a4.webp"
