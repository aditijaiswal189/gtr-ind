      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <p className="text-gray-400 mb-6">
              Your trusted partner in immigration and visa services. We help make your global dreams a reality.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Visa Types</a></li>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-6">Visa Services</h3>
            <ul className="space-y-4">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Family Visa</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="text-center text-gray-400">
            <p>&copy; {new Date().getFullYear()} VisaLand. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
